...
- Send /verify in group & wait for It To Accept Or Directly Contact To Owner After Request @Owner_herebot.
...
Get connected channels list with - /connections"""
    ...
    ABOUT = """Developed By official_kadda

✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/official_kadda'>Harman</a>
